...
def test_data_collection():
    ...
    assert not monthly_weather_data_df.empty, "The weather DataFrame is empty"
    assert monthly_weather_data_df.index.name == "Date", "The index name is not set to 'Date' in weather DataFrame"
